...
By using my_crypto, you can avoid hardcoding passwords, connection strings and other 
...
whatever you want as a pair of key and value. my_crypto stores the data on your local machine and retreive 
